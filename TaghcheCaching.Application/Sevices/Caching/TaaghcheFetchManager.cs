...
{
    public class TaaghcheFetchManager : ManagerService
    {

        private readonly HttpService _httpService;
        private readonly string FETCH_BOOK_URL = "https://get.taaghche.com/v2/book/{0}";

        public TaaghcheFetchManager([FromServices] HttpService httpService)
        {
        ...
        public override async Task<BookResponseModel> GetBook(string id)
        {
            ...
            return new BookResponseModel { Data = response, Message = "Read From Taaghche" };
        }
